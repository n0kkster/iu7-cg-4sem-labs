                     ...
                     const std::string &datatype = "times")
{
    ...
    gp << "set ylabel 'Время (мкс.)'\n";
    gp << "set grid\n";
    gp << "plot 'graphs/times_data2.dаt' using 1:2 with lines lt rgb 'blue' notitle, \
             '' using 1:3 with lines lt rgb 'red' notitle, \
             '' using 1:4 with lines lt rgb 'orange' notitle, \
             '' using 1:5 with lines lt rgb 'green' notitle, \

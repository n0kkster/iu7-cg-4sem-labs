    ...
    QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    connect(ui->clearScreenBtn, &QPushButton::clicked, this,
            &MainWindow::onClearScreenBtnClicked);
    connect(ui->drawLineBtn, &QPushButton::clicked, this,
            &MainWindow::onDrawLineBtnClicked);
    connect(ui->drawRectBtn, &QPushButton::clicked, this,
            &MainWindow::onDrawRectBtnClicked);
    connect(ui->doBtn, &QPushButton::clicked, this,
            &MainWindow::onDoBtnClicked);
    connect(ui->lineColorBtn, &QPushButton::clicked, this,
            &MainWindow::onLineColorBtnClicked);
    connect(ui->rectColorBtn, &QPushButton::clicked, this,
            &MainWindow::onRectColorBtnClicked);
    connect(ui->resColorBtn, &QPushButton::clicked, this,
            &MainWindow::onResColorBtnClicked);
...
void MainWindow::onDrawLineBtnClicked()
{
    ...
    if (!ok)
    {
        QMessageBox::critical(
            this, "Ошибка",
            "Начальная координата X должна быть корректным целым числом.");
        return;
    }
    ...
    if (!ok)
    {
        QMessageBox::critical(
            this, "Ошибка",
            "Начальная координата Y должна быть корректным целым числом.");
        return;
    }
    ...
    if (!ok)
    {
        QMessageBox::critical(
            this, "Ошибка",
            "Конечная координата X должна быть корректным целым числом.");
        return;
    }
    ...
    if (!ok)
    {
        QMessageBox::critical(
            this, "Ошибка",
            "Конечная координата Y должна быть корректным целым числом.");
        return;
    }

    ui->planeWidget->addLine(
        { xs, ys, xe, ye, ui->planeWidget->getLineColor() });
